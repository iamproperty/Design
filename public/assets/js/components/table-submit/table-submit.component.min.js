/*!
  ...
  */const u=t=>t.charAt(0).toUpperCase()+t.slice(1),c=(t=1)=>Math.floor(Math.random()*Date.now()*(t+1)),p=(t,a)=>{switch(t){case"datetime":return new Date(a).toLocaleDateString("en-gb",{weekday:"short",year:"2-digit",month:"long",day:"numeric"})+" "+new Date(a).toLocaleTimeString("en-gb",{hour:"2-digit",minute:"2-digit"});case"date":return new Date(a).toLocaleDateString("en-gb",{day:"numeric",month:"long",year:"2-digit"});case"capitalise":return a=u(a)}},g=(t,a,e,i,o)=>{e.querySelector("[name=show]")||e.insertAdjacentHTML("beforeend",`<input name="show" type="hidden" value="${t.getAttribute("data-show")}" />`),e.querySelector("[name=page]")||e.insertAdjacentHTML("beforeend",`<input name="page" type="hidden" value="${t.getAttribute("data-page")}" />`),i.addEventListener("update-show",l=>{if(e.querySelector("[name=show]").value!=l.detail.show){e.querySelector("[name=show]").value=l.detail.show;const b=new CustomEvent("update-show",{detail:{show:l.detail.show}});t.dispatchEvent(b),h(t,i),o()}}),i.addEventListener("update-page",l=>{if(e.querySelector("[name=page]").value!=l.detail.page){e.querySelector("[name=page]").value=l.detail.page;const b=new CustomEvent("update-page",{detail:{page:l.detail.page}});if(t.dispatchEvent(b),h(t,i),o(),!t.hasAttribute("data-no-scroll")){const s=a.getBoundingClientRect().top+window.pageYOffset+-250;window.scrollTo({top:s,behavior:"smooth"})}}})},f=(t,a)=>{let e=document.createElement("form");return t.hasAttribute("data-filterby")?e=document.querySelector(`#${t.getAttribute("data-filterby")}`):t.closest("form")?e=t.closest("form"):a.parentNode.insertBefore(e,a.nextSibling),e},w=(t,a,e,i)=>{const o=t.shadowRoot.querySelector(".table__wrapper");t.hasAttribute("data-total")||t.setAttribute("data-total",t.querySelectorAll("tbody tr").length),t.hasAttribute("data-page")||t.setAttribute("data-page",1),t.hasAttribute("data-show")||t.setAttribute("data-show",5),t.hasAttribute("data-increment")||t.setAttribute("data-increment",t.getAttribute("data-show")),y(t,i),x(a),v(t,a),t.classList.contains("mh-sm")&&o.classList.add("mh-sm"),t.classList.contains("mh-md")&&o.classList.add("mh-md"),t.classList.contains("mh-lg")&&o.classList.add("mh-lg"),t.classList.contains("table--cta")&&(k(t,a),A(t,a))},y=(t,a)=>{t.hasAttribute("data-total")&&a.setAttribute("data-total",t.getAttribute("data-total")),t.hasAttribute("data-page")&&a.setAttribute("data-page",t.getAttribute("data-page")),t.hasAttribute("data-show")&&a.setAttribute("data-show",t.getAttribute("data-show")),t.hasAttribute("data-increment")&&a.setAttribute("data-increment",t.getAttribute("data-show")),t.hasAttribute("data-page-jump")&&a.setAttribute("data-page-jump","true"),t.hasAttribute("data-per-page")&&a.setAttribute("data-per-page","true"),t.hasAttribute("data-item-count")&&a.setAttribute("data-item-count","true"),t.hasAttribute("data-loading")&&a.setAttribute("data-loading","true"),t.classList.contains("table--fullwidth")&&a.setAttribute("data-minimal","true")},h=(t,a)=>{t.setAttribute("data-total",a.getAttribute("data-total")),t.setAttribute("data-page",a.getAttribute("data-page")),t.setAttribute("data-show",a.getAttribute("data-show")),t.setAttribute("data-increment",a.getAttribute("data-show"))},x=t=>{const a=Array.from(t.querySelectorAll("thead th"));Array.from(t.querySelectorAll("tbody tr")).forEach(i=>{const o=Array.from(i.querySelectorAll("th, td")),l=["0","low","medium","high","unknown","n/a","pending","verified","due","overdue","incomplete","complete","completed","approval required","upcoming","requires approval","to do","on track","not started","warning","successful","failed"];o.forEach((b,n)=>{const s=a[n];if(typeof s<"u"){const d=document.createElement("div");d.innerHTML=s.innerHTML;const m=d.textContent||d.innerText||"";b.setAttribute("data-label",m),s.hasAttribute("data-td-class")&&b.setAttribute("class",s.getAttribute("data-td-class")),s.hasAttribute("data-format")&&(b.setAttribute("data-format",s.getAttribute("data-format")),b.innerHTML=p(s.getAttribute("data-format"),b.textContent.trim())),l.includes(b.textContent.trim().toLowerCase())&&b.setAttribute("data-content",b.textContent.trim().toLowerCase())}})})},v=(t,a)=>{if(t.classList.contains("table--fullwidth")&&!t.hasAttribute("data-expandable")||a.querySelectorAll("thead tr th").length<4&&!t.hasAttribute("data-expandable"))return!1;Array.from(a.querySelectorAll("thead tr")).forEach(e=>{a.querySelectorAll("thead tr th.expand-button-heading").length||e.insertAdjacentHTML("afterbegin",`<th class="${t.hasAttribute("data-expandable")?"th--fixed ":""}expand-button-heading"></th>`)}),Array.from(a.querySelectorAll("tbody tr")).forEach((e,i)=>{const o=e.getAttribute("data-view")==="full"?"aria-expanded":"";e.insertAdjacentHTML("afterbegin",`<td class="${t.hasAttribute("data-expandable")?"td--fixed ":""}td--expand"><button class="btn btn-compact btn-secondary btn-sm" data-expand-button ${o} data-index="${i}">Expand</button></td>`)}),a.addEventListener("click",e=>{if(e&&e.target instanceof HTMLElement&&e.target.closest("[data-expand-button]")){const i=e.target.closest("[data-expand-button]"),o=i.closest("tr");i.toggleAttribute("aria-expanded"),o.getAttribute("data-view")=="full"?o.setAttribute("data-view","default"):o.setAttribute("data-view","full"),i.blur(),t.dispatchEvent(new CustomEvent("row-expanded",{detail:{row:i.getAttribute("data-index")}}))}})},k=(t,a)=>{let e=0;Array.from(a.querySelectorAll("tbody tr")).forEach(i=>{const o=window.getComputedStyle(document.querySelector("html")),l=i.querySelector(":scope > *:last-child > *:first-child");if(l){l.classList.add("text-nowrap");let b=l.offsetWidth/parseFloat(o.fontSize);b+=1.8,e=e>b?e:b}}),t.style.setProperty("--cta-width",`${e}rem`)},A=(t,a)=>{function e(){Array.from(a.querySelectorAll("tr")).forEach(i=>{const o=i.offsetHeight;i.style.setProperty("--row-height",`${o}px`)})}new ResizeObserver(e).observe(a)},L=(t,a)=>{if(t.querySelector("iam-actionbar[data-selectall]")||document.querySelector(`iam-actionbar[data-for='${t.getAttribute("id")}']`)){const e=t.querySelector("iam-actionbar[data-selectall]")?t.querySelector("iam-actionbar[data-selectall]"):document.querySelector(`iam-actionbar[data-for='${t.getAttribute("id")}']`);_(t,a,e)}t.querySelectorAll(".dialog__wrapper .btn-compact").forEach((e,i)=>{const l=e.closest(".dialog__wrapper").querySelector("dialog");if(l){const m=`menu${c(i)}`;l.setAttribute("id",m),l.setAttribute("popover","auto"),e.setAttribute("popovertarget",m),l.outerHTML=l.outerHTML.replace(/<dialog/g,"<iam-menu").replace(/<\/dialog>/g,"</iam-menu>")}e.classList.add("btn-sm"),e.classList.add("m-0");const b=e.closest("tr"),n=e.closest("td"),d=Array.prototype.slice.call(b.children).indexOf(n);n.classList.add("td--fixed"),a.querySelector(`thead tr th:nth-child(${d+1})`).classList.add("th--fixed")})},_=(t,a,e)=>{Array.from(a.querySelectorAll("thead tr")).forEach(i=>{i.querySelector(".expand-button-heading")?i.querySelector(".expand-button-heading").insertAdjacentHTML("afterend",'<th class="th--fixed"></th>'):i.insertAdjacentHTML("afterbegin",'<th class="th--fixed"></th>')}),Array.from(a.querySelectorAll("tbody tr")).forEach((i,o)=>{if(i.setAttribute("data-index",o+1),!i.querySelector(".selectrow")){const l=`row${c(o)}`;i.querySelector(".td--expand")?i.querySelector(".td--expand").insertAdjacentHTML("afterend",`<td class="td--fixed selectrow selected"><input type="checkbox" name="row" id="${l}" ${i.hasAttribute("data-selected")?'checked="true"':""}/><label for="${l}"><span class="visually-hidden">Select row</span></label></td>`):i.insertAdjacentHTML("afterbegin",`<td class="td--fixed selectrow selected"><input type="checkbox" name="row" id="${l}" ${i.hasAttribute("data-selected")?'checked="true"':""}/><label for="${l}"><span class="visually-hidden">Select row</span></label></td>`)}}),a.addEventListener("change",i=>{if(i&&i.target instanceof HTMLElement&&i.target.closest(".selectrow input")){const o=i.target.closest(".selectrow input"),l=i.target.closest("tr"),b=a.querySelectorAll('.selectrow input[type="checkbox"]').length,n=a.querySelectorAll('.selectrow input[type="checkbox"]:checked').length;e.setAttribute("data-selected",b==n?"all":n);const s=new CustomEvent("row-selected",{detail:{rowIndex:l.getAttribute("data-index"),checked:!!o.checked}});t.dispatchEvent(s)}}),e.addEventListener("selected",i=>{if(i.detail.selected=="0"){Array.from(a.querySelectorAll('.selectrow input[type="checkbox"]')).forEach(l=>{l.checked=!1});const o=new CustomEvent("all-rows-unselected");t.dispatchEvent(o)}else if(i.detail.selected=="all"){Array.from(a.querySelectorAll('.selectrow input[type="checkbox"]')).forEach(l=>{l.checked=!0});const o=new CustomEvent("all-rows-selected");t.dispatchEvent(o)}})},S=(t,a,e,i)=>{e.setAttribute("method","get");const o=t.querySelector("iam-actionbar");o&&o.addEventListener("change",l=>{e.submit()})};class q extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),document.body.hasAttribute("data-assets-location")&&document.body.getAttribute("data-assets-location");const a=document.createElement("template");a.innerHTML=`
    <style>
...
</style>`)}connectedCallback(){const a=new URLSearchParams(window.location.search),e=this.shadowRoot.querySelector("iam-pagination"),i=this.querySelector("table"),o=f(this,i);a.has("page")&&this.setAttribute("data-page",a.get("page")),a.has("show")&&this.setAttribute("data-show",a.get("show")),a.has("page")&&e.setAttribute("data-page",a.get("page")),a.has("show")&&e.setAttribute("data-show",a.get("show"));const l=document.body.hasAttribute("data-assets-location")?document.body.getAttribute("data-assets-location"):"/assets";window.customElements.get("iam-menu")||import(`${l}/js/components/menu/menu.component.js`).then(b=>{window.customElements.define("iam-menu",b.default)}).catch(b=>{console.log(b.message)}),w(this,i,o,e),L(this,i),S(this,i,o),g(this,i,o,e,()=>{o.submit()})}}export{q as default};
