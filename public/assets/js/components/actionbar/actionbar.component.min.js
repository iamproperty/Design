/*!
  ...
  */const P=(s=1)=>Math.floor(Math.random()*Date.now()*(s+1));window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:"customElementRegistered",element:"action bar"});function R(s,d){s&&d=="all"?(s.querySelector("input").indeterminate=!1,s.querySelector("input").checked=!0,s.querySelector("label").textContent="Select all"):s&&d==0?(s.querySelector("input").indeterminate=!1,s.querySelector("input").checked=!1,s.querySelector("label").textContent="Select all"):s&&d?(s.querySelector("input").indeterminate=!0,s.querySelector("input").checked=!1,s.querySelector("label").textContent=`${d} item${d>1?"s":""} selected`):s&&(s.querySelector("input").checked=!1,s.querySelector("input").indeterminate=!1,s.querySelector("label").textContent="Select all")}class I extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),document.body.hasAttribute("data-assets-location")&&document.body.getAttribute("data-assets-location");const d=document.createElement("template");d.innerHTML=`
    ...
    `,this.shadowRoot.appendChild(d.content.cloneNode(!0)),document.getElementById("actionbarGlobal")||document.head.insertAdjacentHTML("beforeend",`<style id="actionbarGlobal">iam-actionbar{--actionbar-radius: 0;background-color:#fcfcfc;display:block;border-top-left-radius:0.625rem;border-top-right-radius:0.625rem}@media screen and (prefers-color-scheme: dark){iam-actionbar{background-color:var(--colour-canvas)}}main>.actionbar__sticky-wrapper>.actionbar__sticky>iam-actionbar{border-radius:0.5rem;margin:var(--container-padding);margin-bottom:2rem;box-shadow:2px 6px 12px rgba(0,0,0,.2)}main>.actionbar__sticky-wrapper>.actionbar__sticky>iam-actionbar:first-child{padding-top:0}@media screen and (prefers-color-scheme: light){main>.actionbar__sticky-wrapper>.actionbar__sticky>iam-actionbar{background-color:#e6eaec}}@media screen and (min-width: 36em){main>.actionbar__sticky-wrapper>.actionbar__sticky>iam-actionbar{box-shadow:none;margin-inline:0;border-radius:0}}@media screen and (min-width: 62em){main>.actionbar__sticky-wrapper>.actionbar__sticky>iam-actionbar{padding-inline:calc(50% - 34.75rem - 2rem)}}iam-actionbar~:is([data-view=square],[data-view=list],[data-view=small]){display:none}iam-actionbar[data-view=square]~[data-view=square]{display:block}iam-actionbar[data-view=list]~[data-view=list]{display:block}iam-actionbar[data-view=small]~[data-view=small]{display:block}iam-actionbar .actionbar__text{font-size:1.125rem;line-height:2.5rem;color:var(--colour-heading);display:inline-block}iam-actionbar .menu__wrapper [slot=selected-overflow]>button,iam-actionbar .menu__wrapper [slot=overflow]>button{background:none;border:none;text-indent:0;width:100%;display:block;max-width:100%;text-align:left;padding:0}iam-actionbar .menu__wrapper [slot=selected-overflow]>button:before,iam-actionbar .menu__wrapper [slot=overflow]>button:before{position:static}iam-actionbar button[slot=overflow],iam-actionbar button[slot=selected-overflow]{background:none;border:none;margin:0 !important}iam-actionbar .menu__wrapper [slot=selected-overflow] dialog[open],iam-actionbar .menu__wrapper [slot=overflow] dialog[open]{display:contents}iam-actionbar:has(.selectall input:checked){--selectall-opacity: 1;--selectall-pe: all;--selectall-actionbar-opactiy: 0;--selectall-action-pe: none}/*# sourceMappingURL=assets/css/components/actionbar.global.css.map */
</style>`)}connectedCallback(){var d,A,f,k,x,w,m,b,L,S,E,q;const v=(d=this.shadowRoot)===null||d===void 0?void 0:d.querySelector(".actionbar__wrapper"),h=(A=this.shadowRoot)===null||A===void 0?void 0:A.querySelector(".checklists"),$=document.body.hasAttribute("data-assets-location")?document.body.getAttribute("data-assets-location"):"/assets";window.customElements.get("iam-menu")||import(`${$}/js/components/menu/menu.component.js`).then(t=>{window.customElements.define("iam-menu",t.default)}).catch(t=>{console.log(t.message)});const y=this.querySelector(".dialog__wrapper dialog");if(y){const t=y.parentElement.querySelector(".btn"),e=`menu${P(1)}`;y.setAttribute("id",e),y.setAttribute("popover","auto"),t.setAttribute("popovertarget",e),y.outerHTML=y.outerHTML.replace(/<dialog/g,"<iam-menu").replace(/<\/dialog>/g,"</iam-menu>"),(f=y.parentElement)===null||f===void 0||f.classList.add("menu__wrapper"),(k=y.parentElement)===null||k===void 0||k.classList.remove("dialog__wrapper")}if(this.hasAttribute("data-selectall")){v?.insertAdjacentHTML("afterbegin",'<div class="selectall pb-0"><input type="checkbox" name="selectall" id="selectall"><label for="selectall" class="m-0">Select all</label></div>');const t=(x=this.shadowRoot)===null||x===void 0?void 0:x.querySelector(".selectall");this.hasAttribute("data-selected")&&R(t,this.getAttribute("data-selected")),t?.addEventListener("change",a=>{var o;a&&a.target instanceof HTMLElement&&a.target.closest("input")&&(!((o=a.target.closest("input"))===null||o===void 0)&&o.checked?this.setAttribute("data-selected","all"):this.setAttribute("data-selected","0"))});const e=this.querySelector("button[data-cancel]");e&&e.addEventListener("click",()=>{this.setAttribute("data-selected","0")})}if(this.hasAttribute("data-select-watch")){const t=document.getElementById(this.getAttribute("data-select-watch"));t?.setAttribute("data-select-container","true"),Array.from(t.querySelectorAll('input[type="checkbox"]')).forEach(e=>{var a;(a=e.parentElement)===null||a===void 0||a.setAttribute("slot","checkbox")}),t?.addEventListener("change",e=>{if(e&&e.target instanceof HTMLElement&&e.target.closest('[type="checkbox"]')){const a=t.querySelectorAll('input[type="checkbox"]').length,o=t.querySelectorAll('input[type="checkbox"]:checked').length;this.setAttribute("data-selected",a==o?"all":String(o)),o?Array.from(t.querySelectorAll('input[type="checkbox"]')).forEach(n=>{var i;n.closest("iam-card")&&((i=n.closest("iam-card"))===null||i===void 0||i.setAttribute("data-selected","true"))}):Array.from(t.querySelectorAll('input[type="checkbox"]')).forEach(n=>{var i;n.closest("iam-card")&&((i=n.closest("iam-card"))===null||i===void 0||i.removeAttribute("data-selected"))})}})}if(this.hasAttribute("data-switchviews")){let t="";const e=(w=this.getAttribute("data-switchviews"))===null||w===void 0?void 0:w.split(",");e?.forEach(o=>{let n="fa-grid-2";o=="list"?n="fa-grip-lines":o=="small"&&(n="fa-bars"),t+=`<button class="btn btn-action btn-compact btn-sm mb-0 fa-regular ${n}">${o}</button>`}),v?.insertAdjacentHTML("afterbegin",`<div class="views m-0">${t}</div>`);const a=(m=this.shadowRoot)===null||m===void 0?void 0:m.querySelector(".views");a?.addEventListener("click",o=>{if(o&&o.target instanceof HTMLElement&&o.target.closest(".btn-action")){const n=o.target.closest(".btn-action");this.setAttribute("data-view",n.textContent);const i=new CustomEvent("switch-view",{detail:{view:n.textContent}});this.dispatchEvent(i)}})}const u=(b=this.shadowRoot)===null||b===void 0?void 0:b.querySelector(".actionbar--search");this.hasAttribute("data-search-value")&&(((L=this.shadowRoot)===null||L===void 0?void 0:L.querySelector("#search")).value=String(this.getAttribute("data-search-value"))),this.hasAttribute("data-search")&&this.getAttribute("data-search")=="show"&&u?.classList.add("show");const B=this.shadowRoot.querySelector("button[data-search]");this.shadowRoot.addEventListener("click",t=>{t&&t.target instanceof HTMLElement&&t.target.closest("button[data-search]")&&(u.classList.toggle("show"),B.toggleAttribute("aria-expanded"))}),u.addEventListener("keyup",()=>{const t=new CustomEvent("search-keyup",{detail:{search:u.querySelector("input").value}});this.dispatchEvent(t)}),u.addEventListener("change",()=>{const t=new CustomEvent("search-change",{detail:{search:u.querySelector("input").value}});this.dispatchEvent(t)}),u.addEventListener("click",t=>{if(t&&t.target instanceof HTMLElement&&t.target.closest("button.suffix")){const e=new CustomEvent("search-submit",{detail:{search:u.querySelector("input").value}});this.dispatchEvent(e)}});const j=()=>{const t=v.scrollWidth,e=document.documentElement.scrollWidth;let a=750,o=16,n=450,i=!(this===null||this===void 0)&&this.hasAttribute("data-switchviews")?144:210;this.hasAttribute("data-large-safe-area")&&(a=1048,n=620,i=260);let p=1;e>=992&&e<=1280?p=e/1280:e>=576&&e<992?p=e/768:e<576&&(p=e/375),t>=992&&t<=1280?a=a*p:t>=576&&t<992?a=n*p:t<576&&(a=i*p),o=o*p,t<576?Array.from(this.querySelectorAll(':scope > .btn:not(.js-updated), :scope > .menu__wrapper  > .btn[class*="fa-"]:first-child:not(.js-updated)')).forEach(l=>{l.className=l.className.replace(" btn-compact"," _btn-compact"),l.classList.add("btn-compact"),l.classList.add("js-updated")}):Array.from(this.querySelectorAll(":scope > .btn.js-updated, :scope > .menu__wrapper  > .btn.js-updated:first-child")).forEach(l=>{l.classList.remove("btn-compact"),l.classList.remove("js-updated"),l.className=l.className.replace(" _btn-compact"," btn-compact")}),Array.from(this.querySelectorAll("[slot]")).forEach(l=>{l.getAttribute("slot")=="overflow"&&l.removeAttribute("slot"),l.getAttribute("slot")=="selected-overflow"&&l.setAttribute("slot","selected")}),Array.from(this.querySelectorAll(".show")).forEach(l=>{l.classList.remove("show")}),Array.from(this.shadowRoot.querySelectorAll(".safe-area")).forEach(l=>{var _,M,F;let H="overflow";!((_=l.querySelector("slot"))===null||_===void 0)&&_.hasAttribute("name")&&((M=l.querySelector("slot"))===null||M===void 0?void 0:M.getAttribute("name"))=="selected"&&(H="selected-overflow");const c=(F=l.querySelector("slot"))===null||F===void 0?void 0:F.assignedElements();let g=44*p;this.hasAttribute("data-search")&&(g+=44*p);for(let r=0;r<c.length;r++)!c[r].classList.contains("btn-action")&&!c[r].classList.contains("menu__wrapper ")&&(g+=c[r].offsetWidth,g+=o);for(let r=0;r<c.length;r++)if(c[r].classList.contains("menu__wrapper ")&&(c[r].classList.add("show"),g+=c[r].offsetWidth,g+=o/2,g-o/2>a)){c[r].classList.remove("show");break}for(let r=0;r<c.length;r++)if(c[r].classList.contains("btn-action")&&(c[r].classList.add("show"),g+=c[r].offsetWidth,g+=o/2,g-o/2>a)){c[r].classList.remove("show");break}const z=l.querySelector(".dialog-overflow");z&&z.classList.add("d-none");for(let r=0;r<c.length;r++)(c[r].classList.contains("btn-action")||c[r].classList.contains("menu__wrapper "))&&(c[r].classList.contains("show")||(c[r].setAttribute("slot",H),z&&z.classList.remove("d-none")))})};j(),new ResizeObserver(j).observe(v);const C=()=>{let t="";Array.from(h?.querySelectorAll("label input")).forEach((a,o)=>{t+=this.hasAttribute(`data-hide-col${o+1}`)?`${o+1},`:""}),this.setAttribute("data-columns-shown",h.querySelectorAll("input:checked").length);const e=new CustomEvent("columm-filters-set",{detail:{columnsHidden:t.slice(0,-1)}});this.dispatchEvent(e)};if(this.hasAttribute("data-filter-columns")||this.hasAttribute("data-filter-columns-save")){const t=this.closest("iam-table").querySelectorAll("thead th");Array.from(t).forEach((e,a)=>{e.textContent&&h?.insertAdjacentHTML("beforeend",`<label class="m-0" title="Change the display of "><input name="hideCol${a+1}" value="${a+1}" type="checkbox" ${this.hasAttribute("data-hide-col"+(a+1))?"":"checked"} /> ${e.textContent}</label>`)})}if(this.setAttribute("data-columns-shown",h.querySelectorAll("input:checked").length),this.hasAttribute("data-filter-columns")&&!this.hasAttribute("data-filter-columns-save")&&h?.addEventListener("change",t=>{if(t&&t.target instanceof HTMLElement&&t.target.closest("input")){const e=t.target.closest("input");e?.checked==!1?this.setAttribute("data-hide-col"+e?.value,"true"):this.removeAttribute("data-hide-col"+e?.value),C()}}),this.hasAttribute("data-filter-columns-save")){const t=(S=this.shadowRoot)===null||S===void 0?void 0:S.querySelector(".checklists"),e=(E=this.shadowRoot)===null||E===void 0?void 0:E.querySelector("#saveColumns"),a=(q=this.shadowRoot)===null||q===void 0?void 0:q.querySelector("#cancelColumns");e?.addEventListener("click",o=>{var n;Array.from(t?.querySelectorAll("label input")).forEach(i=>{i?.checked==!1?this.setAttribute("data-hide-col"+i?.value,"true"):this.removeAttribute("data-hide-col"+i?.value)}),C(),(n=e.closest("dialog"))===null||n===void 0||n.close()}),a?.addEventListener("click",o=>{var n,i;const p=(n=this.shadowRoot)===null||n===void 0?void 0:n.querySelector(".checklists");Array.from(p?.querySelectorAll("label input")).forEach((l,_)=>{l.checked=!this.hasAttribute(`data-hide-col${_+1}`)}),C(),(i=e.closest("dialog"))===null||i===void 0||i.close()})}}static get observedAttributes(){return["data-selected"]}attributeChangedCallback(d,A,f){switch(d){case"data-selected":{const k=this.shadowRoot.querySelector(".selectall");k&&R(k,f);const x=new CustomEvent("selected",{detail:{selected:f}});if(this.dispatchEvent(x),f=="all"&&this.hasAttribute("data-select-watch")){const w=document.getElementById(String(this.getAttribute("data-select-watch")));Array.from(w.querySelectorAll('input[type="checkbox"]')).forEach(m=>{var b;m.checked=!0,m.closest("iam-card")&&((b=m.closest("iam-card"))===null||b===void 0||b.setAttribute("data-selected","true"))})}if(f=="0"&&this.hasAttribute("data-select-watch")){const w=document.getElementById(String(this.getAttribute("data-select-watch")));Array.from(w.querySelectorAll('input[type="checkbox"]')).forEach(m=>{var b;m.checked=!1,m.closest("iam-card")&&((b=m.closest("iam-card"))===null||b===void 0||b.removeAttribute("data-selected"))})}break}}}}export{I as default};
